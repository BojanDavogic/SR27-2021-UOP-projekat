...
public class PrimerciKnjigeForma extends JFrame {
	private static final long serialVersionUID = 7636315658143058275L;
	...
	public PrimerciKnjigeForma(BibliotekaApp biblioteka, PrimerakKnjige primerakKnjige, DefaultTableModel tableModel, JTable primerciKnjigeTabela) {
			...
			public void actionPerformed(ActionEvent e) {
				if(validacija()) {
					...
					if(primerakKnjige == null) {
						...
						biblioteka.dodajPrimerak(primerakKnjige);
					...
					PrimerciKnjigeForma.this.dispose();
					PrimerciKnjigeForma.this.setVisible(false);
	...
	private Object[] kreirajRedTabele(PrimerakKnjige primerakKnjige) {
		...
		red[1] = primerakKnjige.getBrojStrana();
		...
		red[4] = primerakKnjige.getKnjiga().getNaslov();
	...
	private void refresh(int red, PrimerakKnjige primerakKnjige) {
		if(red >= 0) {
			...
			tableModel.setValueAt(primerakKnjige.getBrojStrana(), red, 1);
			...
			tableModel.setValueAt(primerakKnjige.getKnjiga().getNaslov(), red, 4);
