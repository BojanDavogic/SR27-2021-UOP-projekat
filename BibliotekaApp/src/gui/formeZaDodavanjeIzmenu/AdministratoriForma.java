...
public class AdministratoriForma extends JFrame {
	private static final long serialVersionUID = -6755265303812743820L;
	...
	public AdministratoriForma(BibliotekaApp biblioteka, Administrator administrator, DefaultTableModel tableModel, JTable administratoriTabela) {
		...
		btnOK.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(validacija()) {
					...
					if(administrator == null) {
						administrator = new Administrator(id, ime, prezime, jmbg, adresa, pol, plata, korisnickoIme, lozinka, false);
	...
	private void popuniPolja() {
		...
		pwfLozinka.setText(String.valueOf(administrator.getLozinka()));
	...
	private Object[] kreirajRedTabele(Administrator administrator) {
		...
		red[8] = administrator.getLozinka();
		return red;
	}
	...
	private void refresh(int red, Administrator administrator) {
		if(red >= 0) {
			...
			tableModel.setValueAt(administrator.getLozinka(), red, 8);
		}
	}
}
